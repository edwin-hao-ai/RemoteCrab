...
public enum IBLocale {
    public enum App {
        public static let name = IBL("Familiar")
        public static let tagline = IBL("Mac receiver")
        public static let captureName = IBL("Familiar")
        public static let receiverName = IBL("Familiar Receiver")
        /// Overflow-menu button label.
        public static let more = IBL("More")
        public static let quit = IBL("Quit Familiar")
    }
    ...
    public enum Permission {
        ...
        public static let cameraReason = IBL("Familiar turns your iPhone's camera into a high-quality webcam for your Mac. We use it in real time — nothing is recorded or uploaded.")

        public static let microphone = IBL("Microphone Access")
        public static let microphoneReason = IBL("Familiar can stream your iPhone's microphone to your Mac. This is optional — toggle it off in the camera screen anytime.")

        public static let localNetwork = IBL("Local Network Access")
        public static let localNetworkReason = IBL("Familiar uses Bonjour to find your Mac on the same WiFi. Without this, the two devices can't talk to each other.")
