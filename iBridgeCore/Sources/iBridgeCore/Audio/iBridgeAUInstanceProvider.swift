...
/// Hook used by the Mac host (iBridgeReceiver) and the
/// `iBridgeAudioExtension` extension to share a single
/// `iBridgeAudioUnit` instance. The extension bundle calls
/// `iBridgeAUInstanceProvider.makeInstance()` from its factory to
...
public enum iBridgeAUInstanceProvider {
