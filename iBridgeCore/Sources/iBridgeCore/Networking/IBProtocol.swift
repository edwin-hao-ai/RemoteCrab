...
/// Bonjour service type used by iBridge. TCP variant because
...
public enum IBServiceType {
    /// The DNS-SD service type advertised by iBridgeCapture.
    /// Always use this exact string for both publishing and browsing.
    public static let tcp = "_ibridge._tcp"
...
/// V0.1 session.
///
/// Sent by iBridgeCapture as the first JSON message after a
/// connection is accepted; consumed by iBridgeReceiver to set up
