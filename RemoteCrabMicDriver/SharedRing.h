...
//  the RemoteCrab Mac app (writer) and the RemoteCrabMicrophone HAL plug-in
...
#ifndef REMOTECRAB_SHARED_RING_H
#define REMOTECRAB_SHARED_RING_H
...
#endif /* REMOTECRAB_SHARED_RING_H */
