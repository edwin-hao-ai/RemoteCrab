...
final class CameraSinkFeeder: @unchecked Sendable {
    ...
    private static let log = Logger(subsystem: "com.ibridge", category: "camera-sink")
    ...
    private let queue = DispatchQueue(label: "com.ibridge.camera-sink")
    ...
    private func connect() -> Bool {
        ...
        setReady(true)
        Self.log.info("attached to Familiar Camera sink stream")
        return true
    }
