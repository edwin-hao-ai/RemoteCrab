...
/// (RemoteCrabReceiver.app → RemoteCrab.app) leaves the record behind: it
...
final class SystemExtensionManager: NSObject, ObservableObject, OSSystemExtensionRequestDelegate, @unchecked Sendable {
    ...
    private static let extensionBundleName = "com.remotecrab.RemoteCrabReceiver.Camera.systemextension"
    private static let extensionExecutableName = "com.remotecrab.RemoteCrabReceiver.Camera"
    ...
    private static let submittedPathKey = "remotecrab.sysexSubmittedAppPath"
    private static let submittedFingerprintKey = "remotecrab.sysexSubmittedFingerprint"
