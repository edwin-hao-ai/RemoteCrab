...
///   • the RemoteCrabAudioUnit (virtual microphone selected by other apps).
///
/// In V0.2 the default sink is the speakers. When the RemoteCrabAudio
/// extension is installed + signed + approved by the user, other apps
/// (Zoom, Slack, OBS) can select "RemoteCrab Microphone" as their mic
...
final class AudioReceiver {
    ...
    private weak var sharedAU: RemoteCrabAudioUnit?
    ...
    func register(audioUnit: RemoteCrabAudioUnit) {
        sharedAU = audioUnit
    }
