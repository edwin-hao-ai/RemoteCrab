...
final class H264Encoder: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate, @unchecked Sendable {
    ...
    private static let log = Logger(subsystem: "com.remotecrab", category: "H264Encoder")
    ...
    private let queue = DispatchQueue(label: "com.remotecrab.h264-encoder")
    ...
    private func createSession() throws {
        ...
        guard status == noErr, let session else {
            throw NSError(domain: "RemoteCrab.H264", code: Int(status),
        ...
        guard setStatus == noErr else {
            throw NSError(domain: "RemoteCrab.H264", code: Int(setStatus),
    ...
    private static let dumpFramesEnabled =
        ProcessInfo.processInfo.environment["REMOTECRAB_DUMP_FRAMES"] == "1"
